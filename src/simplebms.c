...
bitmapword bmw_add_member(bitmapword bmw, int x)
{
	ValidateBmwMember(x);
...
bitmapword bmw_next_member(bitmapword bmw, int prevbit)
{
	bitmapword mask;
...
bitmapword bmw_prev_member(bitmapword bmw, int prevbit)
{
	bitmapword mask;
